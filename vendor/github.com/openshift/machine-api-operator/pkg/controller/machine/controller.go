...
func AddWithActuatorAndFeatureGates(mgr manager.Manager, actuator Actuator, gate featuregate.MutableFeatureGate) error {
...
func AddWithActuatorOpts(mgr manager.Manager, actuator Actuator, opts controller.Options, gate ...featuregate.MutableFeatureGate) error {
	...
	machineControllerOpts.Reconciler = newReconciler(mgr, actuator, gate[0])
