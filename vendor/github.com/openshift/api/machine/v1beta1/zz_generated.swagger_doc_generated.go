...
var map_CPUOptions = map[string]string{
	...
	"coreCount":           "coreCount specifies the number of CPU cores for the instance. The number of valid CPU cores depends on the instance type. When omitted, this means no opinion and the platform chooses the default, which is subject to change without notice.",
	"threadsPerCore":      "threadsPerCore specifies the number of threads per CPU core for the instance. To disable multithreading, specify a value of 1. Otherwise, specify a value of 2 to enable multithreading. The number of valid threads per core depends on the instance type. When omitted, this means no opinion and the platform chooses the default, which is subject to change without notice.",
}
